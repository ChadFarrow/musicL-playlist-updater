...
console.log('🔄 Updating IAM playlist with correct RSS feed URL...\n');

const playlistFile = './playlists/IAM-music-playlist.xml';
const correctRSSUrl = 'https://itsamood.org/itsamoodrss.xml';
...
try {
  ...
  console.log('✅ Successfully updated IAM playlist!');
  ...
  console.log('\n🎉 IAM playlist now references the correct It\'s A Mood RSS feed!');
  
} catch (error) {
  console.error('❌ Error updating IAM playlist:', error.message);
  process.exit(1);
}
