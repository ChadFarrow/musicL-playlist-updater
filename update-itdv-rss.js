...
console.log('🔄 Updating ITDV playlist with correct RSS feed URL...\n');

const playlistFile = './playlists/ITDV-music-playlist.xml';
const correctRSSUrl = 'https://www.doerfelverse.com/feeds/intothedoerfelverse.xml';
...
try {
  ...
  console.log('✅ Successfully updated ITDV playlist!');
  ...
  console.log('\n🎉 ITDV playlist now references the correct Into The Doerfel-Verse RSS feed!');
